...
import com.mengka.springboot.https_iotapp_07.util.StreamUtil;
...
public class HttpsUtil extends DefaultHttpClient {
     ...
     * 密钥库
     */
    private static final String keyStorePath = "/Users/hyy044101331/work_springcloud/work_sanqianyuejia/sanqianyuejia/innotek-tutorial/src/main/resources/iotCert.pkcs12";

    /**
     * 信任库
     */
    private static final String trustStorePath = "/Users/hyy044101331/work_springcloud/work_sanqianyuejia/sanqianyuejia/innotek-tutorial/src/main/resources/truststore.ks";

    private static final String keyPass = "innotek";
    ...
    public HttpsUtil() throws Exception {
        ...
        selfCert.load(new FileInputStream(keyStorePath), keyPass.toCharArray());
        KeyManagerFactory kmf = KeyManagerFactory.getInstance("sunx509");
        kmf.init(selfCert, keyPass.toCharArray());

        // 2 Import the CA certificate of the server,
        KeyStore caCert = KeyStore.getInstance("jks");
        caCert.load(new FileInputStream(trustStorePath), trustPass.toCharArray());
