package com.mengka.springboot.https_iotapp_07.util;
...
public class HttpsUtil extends DefaultHttpClient {
     ...
     * 密钥库
     */
    private static final String keyStorePath = "/Users/hyy044101331/java_tools/tomcat-iotapp_sz1.3/conf/keys/cabbage_client/cabbage.keystore";

    /**
     * 信任库
     */
    private static final String trustStorePath = "/Users/hyy044101331/java_tools/tomcat-iotapp_sz1.3/conf/keys/cabbage_client/cabbagetrust.keystore";
    ...
    public HttpsUtil() throws Exception {
        ...
        KeyStore selfCert = KeyStore.getInstance("jks");
