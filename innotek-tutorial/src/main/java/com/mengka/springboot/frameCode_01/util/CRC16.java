 ...
 *
 * @author ZHY
 * @version MsgCollect1.0, 2016/6/8
 * @since MsgCollect1.0
 */
public class CRC16 {
     ...
     * @return CRC16校验值
     */
    public static int calcCrc(int[] data) {
     ...
     * @return CRC16校验值
     */
    public static int calcCrc(int[] data, int offset, int len) {
        int crcHigh = 0xff;
        int crcLow = 0xff;
        int iIndex;
        for (int i = 0; i < len - 1; ++i) {
            iIndex = (crcLow ^ data[offset + i]) & 0x00ff;
            crcLow = crcHigh ^ crc16_tab_h[iIndex];
            crcHigh = crc16_tab_l[iIndex];
        }

        return ((crcHigh & 0x00ff) << 8) | (crcLow & 0x00ff) & 0xffff;
    }
}
