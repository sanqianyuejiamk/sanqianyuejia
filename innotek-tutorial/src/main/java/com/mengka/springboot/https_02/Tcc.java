...
public class Tcc {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 密钥库
        String trustStorePath = "/Users/hyy044101331/java_tools/apache-tomcat-8.0.46-wechat-https/conf/keys6/server.keystore";
        // 信任库
        ...
        HttpsPost.initHttpsURLConnection(password, password,keyStorePath, trustStorePath);
        // 发起请求
